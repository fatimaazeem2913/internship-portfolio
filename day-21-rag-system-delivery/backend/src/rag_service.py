...
Instructions:
1. Provide a direct, complete explanation with full mathematical formulas, equations, and algorithms where applicable.
2. Every factual statement, formula, or definition MUST have an inline citation in the format: [Source: <filename>, Page: <page>].
3. If the retrieved context does not contain sufficient details to answer, state: "The provided documentation does not contain information to answer this question."
4. Do not invent equations or extrapolate beyond what is documented in the context.
